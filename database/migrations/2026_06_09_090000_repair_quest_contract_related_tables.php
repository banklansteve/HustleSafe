...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('quest_contracts')) {
        ...
        if (! Schema::hasTable('quest_contract_deliverables')) {
        ...
        if (! Schema::hasTable('quest_contract_milestones')) {
        ...
        if (! Schema::hasTable('quest_contract_amendments')) {
    ...
    {
        // Intentionally empty — repair migration only adds missing tables.
    }
};
