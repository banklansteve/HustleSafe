...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('moderation_case_triggers')) {
        ...
        if (! Schema::hasTable('moderation_decisions')) {
        ...
        if (! Schema::hasTable('moderation_keywords')) {
        ...
        if (! Schema::hasTable('moderation_notification_templates')) {
        ...
        if (Schema::hasTable('moderation_settings') && DB::table('moderation_settings')->count() === 0) {
        ...
        if (Schema::hasTable('moderation_keywords') && DB::table('moderation_keywords')->count() === 0) {
        ...
        if (Schema::hasTable('moderation_notification_templates') && DB::table('moderation_notification_templates')->count() === 0) {
