...
return [
    'resources' => [
        ...
        'activity_logs' => [
            ...
            'description' => 'Investigate sign-ins, marketplace actions, verification events, and admin touches for any member across a custom date range.',
            'custom_route' => 'admin.user-activity-history.index',
