...
final class HelpArticleCatalog
{
    ...
    private static function raiseDispute(): array
    {
        return [
            ...
            'summary' => 'If something goes seriously wrong with a funded job, open a formal dispute with evidence — escrow stays protected while both sides are heard.',
            'audience' => 'all',
            ...
            'steps' => [
                ...
                ['title' => 'Respond within the time limits', 'body' => 'The other party has 48 hours to respond in self-resolution. Watch countdown timers on the dispute page and reply with your side if you are the respondent.'],
            ],
            'what_happens_next' => [
                'Escrow release pauses while the dispute is active.',
                'Both parties can message and propose settlements (e.g. partial refund) in the dispute thread.',
                'If you agree on an outcome, record the settlement on-platform.',
                'If timers are missed or you cannot agree, the case escalates for staff review with further evidence deadlines.',
                'Final outcomes may include full release to hustler, full refund to sponsor, or a split — see our Dispute Policy.',
            ],
            'faqs' => [
                ...
                ['question' => 'What if the other party goes silent?', 'answer' => 'Silence can escalate the case automatically after the response window. Keep your evidence uploaded and check email for updates.'],
            ],
