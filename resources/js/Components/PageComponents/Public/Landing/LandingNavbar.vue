        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
            ...
            <nav class="hidden items-center gap-8 lg:flex" aria-label="Primary">
                <a
                    ...
                    :key="item.href"
                    :href="item.href"
                    class="text-sm font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                    :class="
                        navSolid
            ...
            <div class="hidden items-center gap-3 lg:flex">
                <Link
                    v-if="canLogin"
                    :href="route('login')"
                    class="rounded-xl px-4 py-2 text-sm font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                    :class="
                        navSolid
                ...
                <Link
                    v-if="canRegister"
                    :href="route('register')"
                    class="rounded-xl px-4 py-2.5 text-sm font-bold shadow-md ring-1 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                    :class="
                        navSolid
