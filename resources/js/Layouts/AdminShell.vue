...
const navGroups = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Financial health', href: route('admin.financial-health.index'), icon: ChartBarSquareIcon, match: (p) => p.startsWith('/admin/financial-health') },
            { label: 'Financial Control', href: route('admin.financial.index'), icon: CreditCardIcon, match: (p) => p.startsWith('/admin/financial') && !p.startsWith('/admin/financial-review') && !p.startsWith('/admin/financial-audit') && !p.startsWith('/admin/financial-health') && !p.startsWith('/admin/escrow-management') },
