<template>
    ...
    >
        ...
        <div class="rounded-3xl bg-white p-8 shadow-xl shadow-slate-300/40 ring-1 ring-slate-200/90 sm:p-10">
            <h1 class="font-display text-3xl font-extrabold tracking-tight text-slate-900">
                Welcome back
            </h1>
            ...
            <form class="mt-8 space-y-6" @submit.prevent="submit">
                ...
                <div v-if="googleLoginEnabled" class="space-y-4">
                    ...
                    <a
                        ...
                        class="flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3.5 text-sm font-bold text-slate-800 shadow-sm ring-1 ring-slate-200/80 transition hover:bg-slate-50 focus:outline-none focus-visible:ring-4 focus-visible:ring-primary-200"
                    >
